...
INSERT INTO `car`
(`car_type`, `brand`, `fuel`, `car_engine`, `hp`, `model`, `sitting_places`, `rent_price`, `deleted`,`rate`)
VALUES
...
INSERT INTO `car`
(`car_type`, `brand`, `fuel`, `car_engine`, `hp`, `model`, `sitting_places`, `rent_price`, `deleted`)
VALUES
